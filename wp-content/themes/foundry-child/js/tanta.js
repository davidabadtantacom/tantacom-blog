...
jQuery(document).ready(function(){
	...
	if (jQuery('.notFoundZone').length){jQuery('.notFoundZone').find('.background-image-holder').animate ({opacity: 1}, {duration: 1000, queue: false});jQuery('.notFoundZone').find('.container').animate ({opacity: 1}, {duration: 5000, queue: true});}
});